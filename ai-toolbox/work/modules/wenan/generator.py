...
from modules.common.compliance import COMPLIANCE_SHARED_RULES as _COMPLIANCE_SHARED_RULES
...
_CONTENT_BLOCK_RULES = _COMPLIANCE_SHARED_RULES + [
    # ── 假体验（仅 generator.py 使用）──
    ("查了", "假体验"),
    ("百度", "假体验"),
    ("资料显示", "假体验"),
    ("官方说", "假体验"),
