...
echo   [5/5] AI-宣传 ^(Express :3000^)
start "AI-宣传 :3000" cmd /k cd /d D:\0703\ai-toolbox\alxuanchuan ^&^& echo Express+React http://localhost:3000 ^&^& npm run dev ^&^& pause

echo.
echo   ============================================
echo   全部 5 个服务已启动，各自在独立窗口运行
echo   ============================================
echo.
